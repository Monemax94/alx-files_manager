 ...
 * @param {number} size thumbnail width.
...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Welcome to ALX-Files_Manager by Andrew Wreford';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/wrefinity/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'A file management API built with Node.js by ',
      '<a href="https://github.com/wrefinity">Wrefinity and Monex </a>. ',
